...
<?php		if ($msgset<4) {		
		...
		if (isset($mathchaturl) && $chatset==1) {
			echo "<a href=\"$mathchaturl?uname=".urlencode($userfullname)."&amp;room=$cid&amp;roomname=".urlencode($coursename)."\"  target=\"chat\">Chat</a>  ($activechatters) <br/>";
		}
	?>
		</span>
		<div class=clear></div>
